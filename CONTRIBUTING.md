...
First off, thank you for considering contributing to ashuanu.
...
[issue-tracker]: https://github.com/anshulrgoyal/ashuanu/issues
...
```shell
git clone https://github.com/anshulrgoyal/ashuanu
cd ashuanu
cargo build
```
